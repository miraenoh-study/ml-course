...
# Convolution Layer
CNN.add_layer('Conv Layer 1', ConvolutionLayer(in_channels=in_channnel, out_channels=8, kernel_size=3, stride=1, pad=1))

# ReLU Layer
CNN.add_layer('ReLU Layer 1', ReLU())

# Convolution Layer
CNN.add_layer('Conv Layer 2', ConvolutionLayer(in_channels=8, out_channels=8, kernel_size=3, stride=1, pad=1))
